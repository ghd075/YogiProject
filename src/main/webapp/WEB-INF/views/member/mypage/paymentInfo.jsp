...
<section class="myInfoContainer emptySpace cen">
    ...
    <article class="mypageContainer">
        ...
        <div class="myPageTabcontBox">
                            ...
                            <div class="card-body">
                                ...
                                <form name="updatePoint">
                                    ...
                                    <div class="form-group text-md-end">
                                        ...
                                        <c:if test="${plNo > 0 }">
                                           <input class="btn btn-outline-danger" type="button" onclick="location.href='/partner/buyPlan.do?plNo=${plNo}&stay=true'" value="그룹 페이지로 돌아가기">
                                        </c:if>
                                    </div>
                                </form>
                            </div>
            ...
            <div class="tabcont"><br>
              ...
              <div class="col-sm-4">
               <div class="form-check" style="display: inline-block; margin-right: 50px;">
                 <input type="radio" class="form-check-input" id="radio1" name="optradio" value="option1" checked onclick="getAir()">항공상품
                 <label class="form-check-label" for="radio1"></label>
               </div>
               <div class="form-check" style="display: inline-block;">
                 <input type="radio" class="form-check-input" id="radio2" name="optradio" value="option2" onclick="getStay()">숙박상품
           ...
           <table class="table taleStay">
             ...
             <tbody>
              <tr style="height: 80px;">
                  ...
                  <td>
                     <span>제주신라호텔</span><br>
                     <img src="/resources/images/stay/list/제주신라.PNG" style="width: 100px; height: 80px;">
                  </td>
                  <td>동행</td>
                  ...
                  <td>
                    <button class="btn btn-primary ticketBtn" style="margin-left: 10px; width: 80px;">취소</button>
                  </td>
                 </tr>
             </tbody>
           </table>
           ...
           <div class="row">
             <div class="col-sm-12">
               <!-- <button class="btn btn-success" onclick="downloadExcel()">엑셀 출력하기</button> -->
...
<script>
   ...
   $(function(){
      ...
      var searchStep = 5;   // 5개씩 로딩
       ...
       document.getElementById('PDFDownload').addEventListener('click', function () {
           html2canvas(document.querySelector('#myModal .modal-body')).then(canvas => {
  ...
  /*   function downloadExcel(){
      ...
      xhr.open("get","/mypage/downloadPayHistoryAsExcel.do",true);
